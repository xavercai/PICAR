...
#define PIN_SENSOR_LEFT    04    // 左GP2Y0A21YK0F OUT模拟
#define PIN_SENSOR_RIGHT   05    // 右GP2Y0A21YK0F OUT模拟
...
#define PIN_LEFT_DIR1      9     // 新增补齐，IN1复用PWM引脚
#define PIN_LEFT_DIR2      46

// 右电机（AT8236 IN1=PWM, IN2=方向）
#define PIN_RIGHT_PWM      16
#define PIN_RIGHT_DIR1     16    // 新增补齐，IN1复用PWM引脚
...
<div class='box'>
    ...
    <div class='subtitle'>
        ...
        <span style='color:#888;font-size:12px;'>| GP2Y0A21YK0F</span>
    </div>
...
<div class='footer'>
    <span>✅ v5.9 GP2Y0A21YK0F</span> | 纯模拟方案 | 去滤波·去标定·去PID | 只观察·不优化
</div>
...
void setup() {
    ...
    Logger::log("  ✅ 物理噪声：悬空ADC引脚 (GPIO38)");
